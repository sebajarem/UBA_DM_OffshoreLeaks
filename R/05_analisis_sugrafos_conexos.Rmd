---
title: "Análisis Subgrafos Conexos"
output: 
  html_notebook:
    toc: yes
...
knitr::opts_knit$set(root.dir = "..", results = 'hold', warning = F, message = F)
```
...
Empiezo levantando los datos de nodos y aristas ya limpios para armar el grafo.
...
## metricas de cada subgrafo sin betweenness
...
## metricas de cada subgrafo. solo page rank
...
## metricas de cada subgrafo. solo betweenness
